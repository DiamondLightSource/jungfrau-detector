/*
 * JungfrauDefinitions.h
 *
 *  Created on: 6 Apr 2017
 *      Author: Matt Taylor
 */

#ifndef INCLUDE_JUNGFRAUDEFINITIONS_H_
#define INCLUDE_JUNGFRAUDEFINITIONS_H_
...
namespace Jungfrau
{
  ...
  static const std::string DEV_SHM_PATH = "/dev/shm/jungfrau";

  enum JungfrauMessageType
  {
    GLOBAL_HEADER_NONE,
  ...
  typedef struct
  {
    JungfrauMessageType messageType;
    int frame_number;
    uint32_t series;
  ...
  enum JungfrauMessageParentType
  {
...
#endif /* INCLUDE_JUNGFRAUDEFINITIONS_H_ */
